...
class _$_User implements _User {
  ...
  @override
  String toString() {
    return 'User(id: $id, email: $email, name: $name, medicines: $medicines)';
  }
...
abstract class _User implements User {
  const factory _User(
      ...
      @UsernameConverter() required final Username name,
      required final List<Medicine> medicines}) = _$_User;
